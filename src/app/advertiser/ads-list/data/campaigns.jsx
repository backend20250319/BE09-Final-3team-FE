...
자연을 담은 믿음직한 유기농 사료로 반려동물의 진짜 건강을 경험해보세요.`,
    ...
    {
      ad_no: 2,
      title: "프리미엄 유기농 반려묘 사료",
      content: "",
      objective: "무곡물·무첨가 유기농 고양이 사료를 반려묘에게 급여하시고 먹는 모습과 후기를 공유해주세요.",
      image: "/campaign-2.jpg",
      brand_url: "/campaign/brand-1.jpg",
      announce_start: "2025-09-01",
      announce_end: "2025-09-30",
      campaign_start: "",
      campaign_end: "",
      ad_status:"pending",
      applicants: "0 / 100",
    ...
    {
      ad_no: 3,
      title: "저알러지 유기농 반려견 사료 체험",
      content: "",
      objective: "민감한 피부와 장을 위한 저알러지 유기농 사료를 급여하고 효과를 리뷰해주실 분을 모집합니다.",
      image: "/campaign-4.jpg",
      brand_url: "/campaign/brand-1.jpg",
      announce_start: "2025-09-01",
      announce_end: "2025-09-15",
      campaign_start: "",
      campaign_end: "",
      ad_status:"pending",
      applicants: "0 / 30",
    ...
    {
      ad_no: 6,
      title: "다이어트용 유기농 사료 체험",
      content: "",
      objective: "체중 관리가 필요한 반려 강아지를 위해 설계된 유기농 다이어트 사료를 급여·리뷰해주실 분을 모집합니다.",
